<div class="create-album-header">
    <h1 class="text-success">List of public albums</h1>
</div>
        ...
        <div class="col-md-3">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    ...
                    <span class="vote-num"><?= htmlspecialchars($album['votes']) ?></span>
                    <a href="/albums/vote/<?= $album['id'] ?>" class="big"><span class="vote-album pull-right"></span></a>
                </div>
